...
const VideoComment = ({data}) => {
  return (
    <div className="my-6">
        ...
        <input className="w-full bg-transparent border-b p-2 outline-none" placeholder="Add your comment" type="text" />
            ...
            <div className="flex gap-2 items-start px-1 py-4">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-5 items-center">
                        ...
                        <div className="flex gap-1 hover:bg-gray-700 p-1 rounded cursor-pointer">
                            <AiFillDislike/>
                            <span className="hover:bg-gray-700 p-1 rounded cursor-pointer">Reply</span>
                        </div>
